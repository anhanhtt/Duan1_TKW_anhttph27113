                        ...
                        <div class="col-lg-7">
                            <div class="card shadow-lg border-0 rounded-lg mt-5">
                                <div class="card-header">
                                    <h3 class="text-center font-weight-light my-4">THÊM MỚI LOẠI HÀNG HÓA</h3>
                                </div>
                                <div class="card-body">
                                    <form action="index.php?act=adddm" method="post">
                                        ...
                                        <div class="form-floating mb-3">
                                            <input class="form-control" id="inputFirstName" name="type_name" />
                                        ...
                                        <div class="mt-4 mb-0">
                                            ...
                                            <div class="d-grid">
                                                <input class="btn btn-success btn-block" type="submit" name="themmoi" value="THÊM MỚI">
